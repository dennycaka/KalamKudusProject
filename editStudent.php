		...
		<div id="container">
			...
			<div class="content">
				<div style="margin-bottom: 20px;">
					<h1 style="display:inline;">Registered Students</h1>
					<button style="float:right; margin-top:10px;" type="button" name="add" id="add" data-toggle="modal" data-target="#add_dataModal" class="btn btn-warning">Add New Student</button>
				</div>
				<br/>
					...
					<div id="student_table">
						<table class="table table-bordered table-hover">
							...
							<?php
								...
								$query3 = "SELECT * FROM students LIMIT $mulai, $halaman";
      ...
      <div class="modal-dialog">  
           <div class="modal-content">  
                ...
                <div class="modal-body">  
					...
					<label>Enter student religion</label>
...
$(document).ready(function(){  
	...
	$(document).on('click','.delete_data',function(e){  
		...
		$('#btnyes').click(function() {
			...
			$(location).attr('href','editStudent.php');
